...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={`sticky top-0 z-50 py-5 px-6 sm:px-10 lg:px-12 border-b transition-all duration-300 ${
        scrolled
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          {['Home', 'About Us', 'Services', 'Experience', 'Skill', 'Portfolio'].map((item, index) => {
            const sectionMap = {
              'Home': 'home',
              'About Us': 'about',
              'Services': 'tech-stack',
            ...
            return (
              <motion.a
                ...
                className={`text-sm font-medium cursor-pointer transition-colors ${
                  index === 0 ? 'text-slate-800 dark:text-slate-200' : 'text-slate-500 dark:text-slate-400'
                } hover:text-[#0D9488]`}
