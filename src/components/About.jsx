...
export default function About() {
  ...
  return (
    <div id="about" className="bg-[#F0F9FF] dark:bg-[#0C1421] font-['Playfair_Display'] text-slate-700 dark:text-slate-300 antialiased">
        ...
        <main className="container mx-auto max-w-7xl z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="relative w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] rounded-full p-2" style={{ background: 'radial-gradient(circle, rgba(20, 184, 166, 0.15) 0%, rgba(248, 250, 252, 0) 70%)' }}>
                <div className="relative w-full h-full rounded-full p-4" style={{ background: 'radial-gradient(circle, rgba(20, 184, 166, 0.1) 0%, rgba(248, 250, 252, 0) 70%)' }}>
                  <img
                    ref={imageRef}
                    alt="A professional portrait of a smiling web developer with glasses."
                    className="rounded-full w-full h-full object-cover shadow-lg"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCbZvjyJ83c-lAOE1j_eJHwd-EFNTOjzPGIIqKQpbQ6MTZbviVz4jI1Lmz5kO7G1gfMo2zTIQoWPVHEkhGNkHmlQcK1ZLkiH8sDCfw147h3kR7nrGVfCJkNE_J7T9CbtQ8kxomeRWLkLpRYaBDhMGYtV9_ZZIlUyLQfPoEmYzeHSHeXWEsjZ0EOPWAO2_5PQ-58A43A9g4jh6_Nn0zGe8UxYLk799bZUPRbi5FXVPqv73g7OLX3UgUjJAELmqhTkIUTCtQdeBu3Hlk"
                  />
                </div>
              </div>
              <motion.div
            ...
            >
              <div>
                ...
                >
                  ...
                  <p className="text-sm font-semibold tracking-wider uppercase text-[#0D9488]">About Me</p>
                </motion.div>
                <motion.h1
              ...
              <div className="space-y-6 text-base text-slate-600 dark:text-slate-400">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="text-lg font-semibold text-[#0D9488] mb-2">I Can Develop Anything You Want</h3>
                  <p>As a passionate developer, my journey in coding began with a simple "Hello, World!" and blossomed into a career building robust and scalable web applications.</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="text-lg font-semibold text-[#0D9488] mb-2">I Can Follow Digital Trends</h3>
                  <p>Beyond the screen, I'm an avid hiker, always looking for a new trail to explore. I find that the logical thinking and problem-solving skills from programming translate surprisingly well to navigating the wilderness.</p>
                </motion.div>
              </div>
            </motion.div>
          </div>
